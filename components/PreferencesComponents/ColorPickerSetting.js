...
const accentColors = [
    ...
    { name: 'Red', color: 'bg-red-600 text-white', primary: 'bg-red-600', hover: 'hover:bg-red-700', hoverIcon: 'hover:text-red-600 focus:text-red-600', secondary: 'bg-red-100', secondaryHover: 'hover:bg-red-200', text: 'text-white', contentText: 'text-black', icon: 'text-red-600' },
    ...
    { name: 'Dark', color: 'bg-black text-white', primary: 'bg-black', hover: 'hover:bg-white hover:text-black', hoverIcon: 'hover:text-black focus:text-black', secondary: 'bg-gray-500', secondaryHover: 'hover:bg-gray-700', text: 'text-white', contentText: 'text-white', icon: 'text-black' },
  ]
