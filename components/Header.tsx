    ...
    <header className='flex justify-between p-3 lg:p-5 max-w-7xl mx-auto border-b-2 sticky top-0 z-50 bg-white'>
        <div className="flex items-center space-x-5">
            ...
            <form onSubmit={search}>
                <input name='searchField' type="text" placeholder='Search...' className='hidden md:block px-4 py-2 rounded-lg w-72 border border-0 border-b-2 border-blue-500' />
            </form>
        </div>
        <div className="flex items-center space-x-5">
            <Link href='/'>
                <h3 className='flex flex-col items-center cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 text-blue-500 w-7" viewBox="0 0 20 20" fill="currentColor">
