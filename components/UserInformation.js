...
function UserInformation(props) {
  ...
  <div className='flex flex-col space-2 lg:h-full lg:fixed scrollbar-hide overflow-y-auto'>
      ...
      <UserInfoCard name={session ? session.user.name : userInfo.name} fieldOfExpertise={userInfo.fieldOfExpertise} jobDesignation={userInfo.jobDesignation} uid={userInfo.uid} username={userInfo.username} pfp={session ? session.user.image : ''} articles={userInfo.articles} followers={userInfo.followers} following={userInfo.following} />
