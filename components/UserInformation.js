...
function UserInformation(props) {
  ...
  <div className='flex flex-col space-2 lg:h-screen lg:sticky lg:pb-20 lg:top-10 scrollbar-hide overflow-y-auto'>
      ...
      <UserInfoCard name={userInfo.name} fieldOfExpertise={userInfo.fieldOfExpertise} jobDesignation={userInfo.jobDesignation} uid={userInfo.uid} username={userInfo.username} articles={userInfo.articles} followers={userInfo.followers} following={userInfo.following} />
