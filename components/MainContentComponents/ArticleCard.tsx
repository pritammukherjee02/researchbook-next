    ...
    <div className='flex p-5 flex-col justify-around border-0 lg:border-b-2 transition duration-150 ease-in-out rounded-sm'>
        ...
        <div className='flex flex-col md:flex-row gap-3 mt-4 md:items-center'>
            <Link href={`/article/${articleId}`}>
                ...
                {/* <div className='w-full flex items-center border-2 border-red-500 h-44 md:h-[148.27px] md:w-[30%] lg:w-[45%] rounded-lg mx-auto'>
                    <Image src={thumbnailLink} className="object-contain w-[95%] h-[95%] rounded-lg mx-auto my-auto" width={313} height={176} objectFit='cover' />
                </div> */}
