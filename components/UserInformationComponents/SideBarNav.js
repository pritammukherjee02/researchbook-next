...
function SideBarNav() {
  return (
    <div className='flex flex-col gap-2'>
        <Link href='/'>
            <div className='flex items-center px-5 py-3 rounded-full cursor-pointer bg-blue-100'>
        ...
        <Link href='/readlist'>
            <div className='flex items-center px-5 py-3 rounded-full cursor-pointer hover:bg-slate-100'>
