...
function SideBarNav({ page = 'none' }) {
  return (
    <div className='flex flex-col gap-2'>
        <Link href='/'>
            <div className={'flex items-center px-5 py-3 rounded-full transition duration-150 ease-in-out cursor-pointer ' + (page == 'home' ? 'bg-blue-100' : 'hover:bg-slate-100')}>
        ...
        <Link href='/readlist'>
            <div className={'flex items-center px-5 py-3 rounded-full transition duration-150 ease-in-out cursor-pointer ' + (page == 'readlist' ? 'bg-blue-100' : 'hover:bg-slate-100')}>
        ...
        <Link href='/search'>
            <div className={'flex items-center px-5 py-3 rounded-full transition duration-150 ease-in-out cursor-pointer ' + (page == 'search' ? 'bg-blue-100' : 'hover:bg-slate-100')}>
        ...
        <Link href='/notifications'>
            <div className={'flex items-center px-5 py-3 rounded-full transition duration-150 ease-in-out cursor-pointer ' + (page == 'notifications' ? 'bg-blue-100' : 'hover:bg-slate-100')}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline-block mr-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <Link href='/myprofile'>
            <div className={'flex items-center px-5 py-3 rounded-full transition duration-150 ease-in-out cursor-pointer ' + (page == 'myprofile' ? 'bg-blue-100' : 'hover:bg-slate-100')}>
